...
const Header = () => {
	...
	return (
		<HeaderWrapper>
			<Heading text={time.toLocaleTimeString('en-AU', { hour12: true, hour: '2-digit', minute: '2-digit' })} />
			<DateWrapper>{time.toLocaleDateString('en-AU', { weekday: 'long', day: '2-digit', month: 'long', year: 'numeric' })}</DateWrapper>
			<GreetingWrapper>
